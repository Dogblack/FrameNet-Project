...
def get_opt():
    ...
    parser.add_argument('--exemplar_instance_path', type=str, default='./exemplar_instance_dic_bert.npy')
    parser.add_argument('--train_instance_path', type=str, default='./train_instance_dic_bert.npy')
    parser.add_argument('--dev_instance_path', type=str, default='./dev_instance_dic_bert.npy')
    parser.add_argument('--test_instance_path', type=str, default='./test_instance_dic_bert.npy')
    # 保存模型和加载模型相关
    ...
    parser.add_argument('--save_model_path', type=str, default='./models_ft/final_bert_3.bin')
    ...
    parser.add_argument('--encoder_emb_size',type=int, default=768)
    ...
    parser.add_argument('--token_type_emb_size',type=int, default=32)
